    ...
    m_description(new QLabel)
{
    ...
    m_champTypes->insertItem(Type::Depart, tr("Depart"), tr("C'est de cet emplacement que les joueurs débutent la partie. Il reçoivent ensuite un salaire à chaque fois qu'ils passent par cet emplacement. Il ne peut y avoir qu'un seul et unique emplacement de ce type sur le plateau."));
    ...
    m_champTypes->insertItem(Type::Prison, tr("Prison"), tr("Les joueurs qui arrivent en prison ne peuvent en sortir qu'en faisant un double aux dés, en payant une amende, ou en utilisant une carte le permettant. Une prison doit être associée à un emplacement en simple visite. Il ne peut y avoir qu'une seule et unique prison sur le plateau."));
